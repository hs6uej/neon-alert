...
| `art/*.png` | รูปอาคาร/ยูนิตที่แอดมินสร้างในชุดของตัวเอง (รูปที่ไม่มีชุดไหนอ้างอิงจะถูกลบหลัง 1 ชั่วโมง; ชุดสำเร็จรูป V2 อยู่ใน `public/sets/v2/` ตามซอร์ส ไม่อยู่ใน data) | ต่ำ |
