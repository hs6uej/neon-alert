...
(function () {
  ...
  const TH = {
    ...
    'Touch (iPad)': 'ระบบสัมผัส (iPad)', 'Select': 'เลือก', 'Attack': 'โจมตี', 'Stop': 'หยุด', 'Base': 'ฐาน', 'Clear': 'ล้าง', 'Build here': 'วางที่นี่', 'Fire here': 'ยิงตรงนี้', '✕ Cancel': '✕ ยกเลิก',
    'Box select': 'ลากกรอบเลือก', 'Attack-move': 'เคลื่อนที่-โจมตี', 'Go to base': 'ไปที่ฐาน', 'Deselect': 'ยกเลิกการเลือก',
    'Tap a card to build. Tap the map to move / attack · long-press = attack-move · pinch to zoom · drag or use the edge pads to scroll': 'แตะการ์ดเพื่อสร้าง แตะแผนที่เพื่อเดิน/โจมตี · กดค้าง = เคลื่อนที่-โจมตี · ถ่างนิ้วเพื่อซูม · ลากหรือใช้แผ่นขอบจอเพื่อเลื่อน',
    'Nothing to build yet.': 'ยังไม่มีอะไรให้สร้างตอนนี้',
  ...
  const TH_HTML = {
    ...
    help_touch: 'แตะการ์ดเพื่อสร้าง/ฝึกยูนิต <b>แตะ</b>ยูนิตเพื่อเลือก เมื่อเลือกยูนิตแล้ว แตะพื้นเพื่อเดิน แตะศัตรูเพื่อโจมตี <b>ลาก</b>แผนที่หรือใช้ <b>แผ่นเลื่อนใหญ่ตามขอบจอ</b> เพื่อเลื่อนกล้อง <b>ถ่างนิ้ว</b>เพื่อซูม <b>กดค้าง</b>ที่พื้นเพื่อเคลื่อนที่-โจมตี ใช้ปุ่ม <b>Select</b> เพื่อลากกรอบเลือกหลายยูนิต ตอนวางอาคารให้ลากเพื่อเล็งตำแหน่งแล้วกด <b>วางที่นี่</b>',
